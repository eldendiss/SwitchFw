...
esp_err_t LAN_init(){
    ...
    ESP_RETURN_ON_ERROR(esp_eth_driver_install(&eth_config_spi, &eth_handle_spi),TAG, "esp driver install failed");
    ...
    ESP_RETURN_ON_ERROR(esp_eth_ioctl(eth_handle_spi, ETH_CMD_S_MAC_ADDR, mac),TAG, "esp driver install failed");

    // attach Ethernet driver to TCP/IP stack
    ESP_RETURN_ON_ERROR(esp_netif_attach(eth_netif_spi, esp_eth_new_netif_glue(eth_handle_spi)),TAG, "esp driver install failed");

    // Register user defined event handers
    ESP_RETURN_ON_ERROR(esp_event_handler_register(ETH_EVENT, ESP_EVENT_ANY_ID, &eth_event_handler, NULL),TAG, "esp driver install failed");
    ESP_RETURN_ON_ERROR(esp_event_handler_register(IP_EVENT, IP_EVENT_ETH_GOT_IP, &got_ip_event_handler, NULL),TAG, "esp driver install failed");
