...
bool setConversion_r2_command(const std::vector<double> &params){
    ...
    ESP_LOGI("COMMAND", "Conversion factor R2 applied: %.2f", static_cast<float>(params[0]));
...
bool setConversion_r3_command(const std::vector<double> &params){
    ...
    ESP_LOGI("COMMAND", "Conversion factor R3 applied: %.2f", static_cast<float>(params[0]));
...
bool setConversion_r4_command(const std::vector<double> &params){
    ...
    ESP_LOGI("COMMAND", "Conversion factor R4 applied: %.2f", static_cast<float>(params[0]));
